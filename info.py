...
API_ID = int(environ.get('API_ID', '30866116'))
API_HASH = environ.get('API_HASH', '7396e075cae5daeb8eb78131b7ea845c')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1764646793').split()] # For Multiple Id Use One Space Between Each.
